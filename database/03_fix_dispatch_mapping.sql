-- =========================================================================
-- FIX: Update fn_automated_dispatch to use condition-to-specialization mapping
-- Expanded with 36 conditions covering Critical, Chronic, Moderate, and Minor
-- =========================================================================
...
BEGIN
    ...
    -- STEP 3: Find nearest capable hospital (Specialization-Aware)
    ...
    VALUES (
        ...
        CASE WHEN v_Specialization IS NOT NULL THEN ' (Matched: ' || v_Condition || ' → ' || v_Specialization || ')' ELSE '' END
    );
